...
@section('title', 'Enrollments - SkillHub')
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        <div>
                            <div class="text-sm font-medium text-gray-900">{{ $enrollment->participant->name }}</div>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-500">{{ $enrollment->class->instructor }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-500">{{ $enrollment->enrolled_at->format('M d, Y') }}</div>
                </td>
