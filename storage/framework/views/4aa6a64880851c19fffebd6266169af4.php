<?php $__env->startSection('title', 'Edit Participant - SkillHub'); ?>

<?php $__env->startSection('content'); ?>
<div class="mb-6">
    <a href="<?php echo e(route('participants.show', $participant)); ?>" class="text-indigo-600 hover:text-indigo-900 flex items-center">
...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <form action="<?php echo e(route('participants.update', $participant)); ?>" method="POST" class="p-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('address', $participant->address)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/gabrielajs/sertifikasi/resources/views/participants/edit.blade.php ENDPATH**/ ?>